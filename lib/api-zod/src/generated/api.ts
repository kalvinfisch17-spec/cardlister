...
export const ListCardsQueryParams = zod.object({
  ...
  "holoType": zod.enum(['standard', 'holo', 'reverse_holo', 'cosmo_holo']).optional(),
...
export const ListCardsResponseItem = zod.object({
  ...
  "holoType": zod.union([zod.literal('standard'),zod.literal('holo'),zod.literal('reverse_holo'),zod.literal('cosmo_holo'),zod.literal(null)]).nullish(),
